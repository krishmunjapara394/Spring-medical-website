...
import './Traditional Chinese Herbal Therapy.css'
import { traditionalSec1Data } from "./AllServicesSlice";
...
const HerbalTherapy = () => {
    ...
    const traditionalSec1 = useSelector((state) => state.allServicesSlice.traditionalSec1)
            ...
            <nav className="navbar navbar-expand-lg bg-body-tertiary sticky-top">
                <div className="container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul className="navbar-nav ps-xxl-5 ms-xl-0">
                            ...
                            <li className="nav-item-1 dropdown ps-xxl-4">
                                <a className="nav-link dropdown-toggle text-warning" href="./Traditional Chinese Herbal Therapy.html" role="button" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                            ...
                            <li className="nav-item1 ms-xl-5" data-aos="fade-left" data-aos-duration="1000">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 text-white ps-xl-5 my-5 py-4">
                            <h6 className="ms-xl-5 mb-0" data-aos="fade-left" data-aos-duration="1000">HOME | Traditional Chinese Herbal Therapy</h6>
                            <h1 className="ms-xl-5 herbal-h1" data-aos="fade-right" data-aos-duration="1000">Traditional Chinese<br /> Herbal Therapy</h1>
                        </div>
                    </div>
                </div>
            </section>
