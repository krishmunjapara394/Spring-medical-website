...
import { eleSec2Data } from "./AllServicesSlice";
...
const Electrocardiogram = () => {
    ...
    const sec2 = useSelector((state) => state.allServicesSlice.eleSec2)
    ...
    return (
        <>
            ...
            <section className="ele-sec-1">
                <div className="container">
                    <div className="row">
                        <div className="col-12 text-white ps-xl-5 my-5 py-4">
                            <h6 className="ms-xl-5 mb-0" data-aos="fade-left" data-aos-duration="1000">HOME | ELECTROCARDIOGRAM (ECG)</h6>
                            <h1 className="ms-xl-5" data-aos="fade-right" data-aos-duration="1000">Electrocardiogram (ECG)</h1>
                        </div>
                    </div>
                </div>
            </section>
            <section className="p-2 mt-2 ele-sec-2">
                <div className="container">
                    <div className="row">
                        {
                            sec2?.map((a, index) => {
                                return (
                                    <div className="row" key={index}>
                                        ...
                                        <div className="col-lg-6 col-mg-12 mt-lg-5 p-xl-5 p-md-5 p-sm-1 " data-aos="fade-down" data-aos-duration="1000">
                                            <h1 className="s2p1 fw-bold mt-4">{a?.title}</h1>
                                            <p className="s2p3 mt-4">{a?.details}</p>
                                            <p className="s2p3">{a?.description}</p>
                                        </div>
                                    </div>
                                )
                            })
